...
#ifdef __cplusplus
		XUIElementPropVal() {
			((void(*)(...))(ResolveFunction3((HMODULE)GetModuleHandle(StrEnc(MODULE_Dash)), 10079)))(this);
		}
		~XUIElementPropVal() {
			((void(*)(...))(ResolveFunction3((HMODULE)GetModuleHandle(StrEnc(MODULE_Dash)), 10080)))(this);
		}
#endif
	};
...
namespace Dashboard_Calls {
	...
	extern HRESULT(*XuiSceneCreate)(LPCWSTR szBasePath, LPCWSTR szScenePath, void* pvInitData, HXUIOBJ* phScene);
	extern bool(*XuiHandleIsValue)(HXUIOBJ hObj);
}