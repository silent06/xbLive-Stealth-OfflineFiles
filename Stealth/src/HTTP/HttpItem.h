...
typedef enum _HTTP_TYPE {
	HTTP_TYPE_UNDEFINED,
	HTTP_TYPE_CONTENT,
	HTTP_TYPE_CUSTOMSMALL,
	HTTP_TYPE_CUSTOMLARGE
} HTTP_TYPE;
...
public :
	...
	// retry stuff;
	void		setMaxRetry(int value)					  { maxRetry = value;		 }
	int			getMaxRetry()							  { return maxRetry;		 }
	int			getCurRetry()							  { return curRetry;		 }
	void		setCurRetry(int value)				      { curRetry = value;	     }
