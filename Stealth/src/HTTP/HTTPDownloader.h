...
#include <list>
#include <Monitor\Network\NetworkMonitor.h>

#define HTTP_NUM_WORKERS    4

class HTTPDownloader:public CThread, public iTimerObserver, iHttpItemRequester, public iNetworkObserver
{
public:
